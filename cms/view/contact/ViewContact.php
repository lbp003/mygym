                    ...
                    <form method="post" name="viewMsg" action="#" enctype="multipart/form-data">
                        ...
                        <div class="col-md-8">
                             <div class="form-group">
                                ...
                                <input name="from" type="text" class="form-control" id="fname" readonly value="<?php echo $reCon['fname']?>"><br />
                                <input name="from" type="text" class="form-control" id="lname" readonly value="<?php echo $reCon['lname']?>">
                            </div>
                            <div class="form-group">
                                <label for="date">Date & Time</label>
                                <input name="date" type="datetime" class="form-control" id="date" readonly value="<?php echo $reCon['time']?>">
                            </div>
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <textarea type="text" class="form-control" id="msg" name="msg"  rows="15" readonly><?php echo $reCon['message']?></textarea>
                            </div>
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-4"><br />
                                    <a href="../controller/contactController.php?contact_id=<?php echo $contact_id;?>&status=Delete" class="btn btn-lg btn-danger" name="delete" type="submit"  style="float: right" onclick="return deleteRow()">Delete</a>
                                </div>
                            <div class="col-md-4"><br />
                                <a href="notification.php" class="btn btn-lg btn-info center-block" name="back" type="submit" >Inbox</a>
                            </div>
                                <div class="col-md-4"><br />
                                    <a href="Reply.php?contact_id=<?php echo $contact_id;?>" class="btn btn-lg btn-info" name="reply" type="submit"  style="float: left">Reply</a>
                                </div>
                        </div>
                        </div>                       
                    </form>
