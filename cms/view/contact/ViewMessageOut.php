                    ...
                    <form method="post" name="viewMsg" action="#" enctype="multipart/form-data">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="form-group">
                                ...
                                <input name="subject" type="text" class="form-control" id="subject" readonly value="<?php echo $reMsg['subject'];?>">
                            </div>
                             <div class="form-group">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-4"><br />
                                <a href="notification.php" class="btn btn-lg btn-info" name="back" style="float: left">Inbox</a>
                            </div>
                        </div>
                        </div>                       
                    </form>
