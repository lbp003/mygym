        ...
        <div class="container-fluid">
            <div class="row justify-content-center" style="height: 100%;">
                <div class="col-4 pt-5">
                    ...
                    <form method="post" name="forgetPw" action="../../../controller/userController.php?status=forgetPwSt" enctype="multipart/form-data">
                        ...
                        <div class="float-right">
                            ...
                            <a class="btn btn-default text-dark" style="text-decoration: none" href="index.php">Cancel</a>
                        </div>    
                    </form>
                </div>
            </div>
