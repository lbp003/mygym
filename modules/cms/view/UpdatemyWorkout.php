...
<?php 
    ...
    //$lol = $resultRo->fetch_assoc();
    //echo $lol['anatomy_name'];
//    $_SESSION['resultRo']=$resultRo;
//    print_r($resultRo);
$exercise_id = $_REQUEST['exercise_id'];
    $objWup = new workout();
    $result = $objWup->displayWorkout($exercise_id);
    if(!$result){
        die("ERROR".mysqli_error($con));
    }
    $resultUpW =$result->fetch_assoc();
?>
        ...
        <div class="container-fluid">
            ...
            <?php include '../common/AdminSideNav.php'; ?>
                ...
                <div class="col-md-9" style="background-color:rgb(250,250,250); ">
                    ...
                    <form method="post" name="AddmyWorkout" action="../controller/myWorkoutcontroller.php?status=Update&exercise_id=<?php echo $exercise_id?>" enctype="multipart/form-data">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="exercise_name">exercise name</label>
                                <input type="text" name="ename" class="form-control" id="ename" value="<?php echo $resultUpW['exercise_name']?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select id="anatomy_id" name="anatomy" class="form-control">
                                    ...
                                    <option value="<?php echo $anatomy['anatomy_id'] ?>" 
                                        <?php if($anatomy['anatomy_id']==$resultUpW['anatomy_id']) echo "SELECTED"; ?>>
                                        <?php echo ucfirst($anatomy['anatomy_name']) ?>
                                    </option>;
                                    <?php  } ?>
                                </select>
                            </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-4"><br /><br />
                                ...
                                <button class="btn btn-lg btn-info btn-block" name="submit" type="submit" value="Submit">Update</button>
                            </div>
                            <div class="col-md-4"></div>
                            </div>
                        </div>
