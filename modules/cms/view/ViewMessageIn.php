...
$type=$_REQUEST['type'];
   ...
   $reply_from=$userDetails['staff_id'];
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-4"><br />
                                    <a href="../controller/contactController.php?message_id=<?php echo $message_id;?>&status=DeleteMsg" class="btn btn-lg btn-danger" name="delete" style="float: right" onclick="return deleteRow()">Delete</a>
                                </div>
                            <div class="col-md-4"><br />
                                <a href="notification.php" class="btn btn-lg btn-info center-block" name="back">Inbox</a>
                            </div>
                            <div class="col-md-4"><br />
                                    <a href="SendMessageReply.php?id=<?php echo $message_id?>&f=<?php echo $fname?>&l=<?php echo $lname?>&t=<?php echo $type?>&to=<?php echo $reply_to?>&fr=<?php echo $reply_from?>&s=<?php echo $subject;?>" class="btn btn-lg btn-info" name="reply" style="float: left">Reply</a>
                            </div>
                        </div>
                        </div>                       
                    </form>
