        ...
        <div class="container-fluid">
                <div class="row">
                    <ol class="breadcrumb" style="background-color:#2f2f2f">
                        ...
                        <li><a href="#" class="active">View time slot</a></li>
                    </ol>
                </div>
        </div>
        <!--- breadcrumb ending--------->
        <div class="container-fluid">
            ...
            <?php include '../common/AdminSideNav.php'; ?>
                ...
                <div class="col-md-9" style="background-color:rgb(250,250,250); ">
                    <div>
                        <h1 align="center" style="font-family: monospace; font-size: 60px;color: #ffff00;background-color:rgba(70,70,70,0.5);"><b>View Time Slot</b></h1>
                    </div><hr />
                    <div class="row">
                    ...
                    <form method="post" name="UpdateTimeSlot" action="../controller/scheduleController.php?status=Update&schedule_id=<?php echo $schedule_id ?>" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="time" class="form-control" id="stime" name="stime" value="<?php echo $rowSch['start_time']?>" disabled>
                            </div>
                            <div class="form-group">
                                <label for="end_time">End Time</label>
                                <input type="time" class="form-control" id="etime" name="etime" value="<?php echo $rowSch['end_time']?>" disabled>
                            </div>
                            <div class="form-group">
                                <label for="color">Background Color</label>
                                <input type="color" class="form-control" value="#577f92" id="color" name="color" disabled>
                            </div>
                        </div>
                        <div class="col-md-3">&nbsp;</div>
                        <div class="col-md-12">
                            ...
                            <div class="col-md-4"><br /><br />
                                <a href="Schedule.php" class="btn btn-lg btn-info btn-block">Back</a>
                            </div>
                            <div class="col-md-4">&nbsp;</div>
                        </div>
                        </div>                       
