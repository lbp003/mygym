            ...
            if (typeof(gender) !== 'undefined' && typeof(age) !== 'undefined') {
                if (gender == 'Male') {
                    switch (age) {
                        case '19 - 24':
                            if (bmi < 20) {
                                return '<div class="p-5 bg-warning text-warning">Underweight</div>';
                            } else if (bmi > 25) {
                                return '<div class="p-5 bg-danger text-danger">Over Weight</div>';
                            } else {
                                return '<div class="p-5 bg-success text-success">Normal Weight</div>';
                            }
                            break;
                        case '25 - 34':
                            if (bmi < 21) {
