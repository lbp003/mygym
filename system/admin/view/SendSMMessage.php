<!--- header start ---->
<?php include_once '../common/adHeader.php'; ?>
<!--- header end ---->
        ...
        <div class="container-fluid">
            ...
            <?php include '../common/AdminSideNav.php'; ?>
                ...
                <div class="col-md-9" style="background-color:rgb(250,250,250); ">
                    ...
                    <form method="post" name="SendMsg" action="../controller/contactController.php?status=SendSMmsg" enctype="multipart/form-data">
                        <div class="col-md-2">&nbsp;</div>
                        <div class="col-md-8">
                            <div class="form-group">
                                 <label for="from" style="display: none">From</label>
                                <input name="fromStaff" type="hidden" class="form-control" id="from" readonly value="<?php echo $userDetails['staff_id']?>">
                            </div>
                            <div class="form-group">
                                <label for="To">To</label>
                                <input type="text" class="form-control typeahead" data-provide="typeahead" id="toMember" name="toMember" autocomplete="off">
                            </div>
                            <div class="form-group">
