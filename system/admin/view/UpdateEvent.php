        ...
        <div class="container-fluid">
            ...
            <?php include '../common/AdminSideNav.php'; ?>
                ...
                <div class="col-md-9" style="background-color:rgb(250,250,250); ">
                    ...
                    <form method="post" name="UpdateEvent" action="../controller/eventcontroller.php?status=Update&event_id=<?php echo $event_id;?>" enctype="multipart/form-data">
                        <div class="col-md-3">&nbsp;</div>
                        <div class="col-md-6">
                             <div class="form-group">
                                <label for="event_title">Event Title</label>
                                <input name="event_title" type="text" class="form-control" id="etitle" value="<?php echo $resultUpEv['event_title']; ?>">
                            </div>
                            <div class="form-group">
                                <label for="event_date">Event Date</label>
                                <input type="date" class="form-control" id="etime" name="event_date" value="<?php echo $resultUpEv['event_date']; ?>">
                            </div>
                            <div class="form-group">
                                <label for="event_date">Event Venue</label>
                                <input type="text" class="form-control" id="etime" name="event_venue" value="<?php echo $resultUpEv['event_venue']; ?>">
                            </div>
                             <div class="form-group">
                                <label for="event_description">Event Description</label>
                                <textarea type="text" class="form-control" id="edes" name="event_description"  rows="15"><?php echo $resultUpEv['event_description']; ?></textarea>
                            </div>
                             ...
                             <div class="form-group">
                                ...
                                ?>
                                <img  class="img-responsive img-thumbnail center-block" src="<?php echo $path;?>" width="300px"/>
                            </div>
                            </div>
                        <div class="col-md-3">&nbsp;</div>
                        <div class="col-md-12">
                           <div class="row">
                            ...
                            <div class="col-md-4">
                                <a  href="event.php" class="btn btn-lg btn-danger btn-block" name="cancel" value="Cancel">Cancel</a>
