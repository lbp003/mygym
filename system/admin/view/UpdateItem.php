        ...
        <div class="container-fluid">
            ...
            <?php include '../common/AdminSideNav.php'; ?>
                ...
                <div class="col-md-9" style="background-color:rgb(250,250,250); ">
                    <div>
                        <h1 align="center" style="font-family: monospace; font-size: 60px;color: #ffff00;background-color:rgba(70,70,70,0.5);"><b>Update  Item</b></h1>
                    </div><hr />
                    <div class="row">
                    ...
                    <form method="post" name="UpdateItem" action="../controller/itemController.php?status=Update&item_id=<?php echo $item_id;?>" enctype="multipart/form-data">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="iname" name="item_name" value="<?php echo $resultUp['item_name']?>">
                            </div>
                            <div class="form-group">
                                <label for="quantity">Quantity</label>
                                <input type="number" class="form-control" id="qty" name="qty" value="<?php echo $resultUp['qty']?>">
                            </div>
                             <div class="form-group">
                                <label for="Unit Price">Unit Price</label>
                                <input type="number" class="form-control" id="up" name="unit_price" value="<?php echo $resultUp['unit_price']?>">
                            </div>
                            <div class="form-group">
                                <label for="Last Updated User" style="display: none">Last Updated User</label>
                                <input type="hidden" class="form-control" id="u_staff_id" name="last_updated_user" value="<?php echo $staff_id?>">
                            </div>
                            </div>
                        <div class="col-md-3">&nbsp;</div>
                        <div class="col-md-12">
