        ...
        <div class="col-md-12 col-lg-12 reg-bg ">
            ...
            <div class="row">
                ...
                <div class="col-md-6 reg-form">
                    ...
                    <div><h3>Select a Package</h3></div>
                    <section>
                        <?php while ($row = $result->fetch_assoc()){
                        $path="../admin/images/package_image/".$row['package_image'];
                        ?>
                        <div class="col-md-6">
                            <div>
                                <div><img class="img-thumbnail img-responsive" src="<?php echo $path?>" alt="package image"/></div>
                                <div><h2><?php echo $row['package_name']?></h2></div>
                                <div><p><?php echo $row['package_description']?></p></div>
                            </div>                           
                        </div>
                        <?php } ?>
                    </section>
