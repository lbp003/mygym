        ...
        <div class="container-fluid">
            ...
            <?php include '../common/myPlanSideNav.php'; ?>
                ...
                <div class="col-md-9" style="background-color:rgb(250,250,250); ">
                    ...
                    <form method="post" name="SendMsg" action="../admin/controller/contactController.php?status=SendMMmsg" enctype="multipart/form-data">
