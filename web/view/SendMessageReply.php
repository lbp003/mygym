...
<?php 
 ...
 $lname=$_REQUEST['l'];
 $type=$_REQUEST['t'];
 $reply_to=$_REQUEST['to'];
 $reply_from=$_REQUEST['fr'];
 $subject=$_REQUEST['s'];
        ...
        <div class="container-fluid">
            ...
            <?php include '../common/myPlanSideNav.php'; ?>
                ...
                <div class="col-md-9" style="background-color:rgb(250,250,250); ">
                    ...
                    <form method="post" name="viewMsg" action="../admin/controller/contactController.php?status=SendMsgReply&type=<?php echo $type?>&wh=M" enctype="multipart/form-data">
                        <div class="col-md-2">
                        </div>
                        <div class="col-md-8">
