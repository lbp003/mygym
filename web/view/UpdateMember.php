        ...
        <div class="container-fluid">
            ...
            <?php include '../common/myPlanSideNav.php'; ?>
                ...
                <div class="col-md-9" style="background-color:rgb(250,250,250); ">
                    <div>
                        <h1 align="center" style="font-family: monospace; font-size: 60px;color: #ffff00;background-color:rgba(70,70,70,0.5);"><b>Edit Profile</b></h1>
                    </div><hr />
                    <div class="row">
                    ...
                    <form method="post" name="UpdateMember" action="../admin/controller/membercontroller.php?status=Edit&member_id=<?php echo $member_id;?>" enctype="multipart/form-data">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <?php 
                                    if($resultUpMe['member_image']==""){
                                        ...
                                        $path="../admin/images/member_image/".$resultUpMe['member_image'];
                                    }
                                ?>
                        ...
                        <div class="col-md-12">
                           <div class="row">
                            ...
                            <div class="col-md-4">
                                <a  href="myPlan.php" class="btn btn-lg btn-danger btn-block" name="cancel" value="Cancel">Cancel</a>
